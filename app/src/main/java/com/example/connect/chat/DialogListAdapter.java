...
public class DialogListAdapter<DIALOG extends IDialog>
        extends RecyclerView.Adapter<com.example.connect.chat.DialogListAdapter.BaseDialogsViewHolder> {

    protected List<DIALOG> items = new ArrayList<>();
    private int itemLayoutId;
    private Class<? extends BaseDialogsViewHolder> holderClass;
    private ImageLoader imageLoader;
    private com.example.connect.chat.DialogListAdapter.OnDialogClickListener<DIALOG> onDialogClickListener;
    private com.example.connect.chat.DialogListAdapter.OnDialogViewClickListener<DIALOG> onDialogViewClickListener;
    private com.example.connect.chat.DialogListAdapter.OnDialogLongClickListener<DIALOG> onLongItemClickListener;
    private com.example.connect.chat.DialogListAdapter.OnDialogViewLongClickListener<DIALOG> onDialogViewLongClickListener;
    ...
    public BaseDialogsViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        try {
            ...
            if (baseDialogsViewHolder instanceof com.example.connect.chat.DialogListAdapter.DialogsViewHolder) {
     ...
     */
    public com.example.connect.chat.DialogListAdapter.OnDialogClickListener getOnDialogClickListener() {
     ...
     */
    public void setOnDialogClickListener(com.example.connect.chat.DialogListAdapter.OnDialogClickListener<DIALOG> onDialogClickListener) {
     ...
     */
    public com.example.connect.chat.DialogListAdapter.OnDialogViewClickListener getOnDialogViewClickListener() {
     ...
     */
    public void setOnDialogViewClickListener(com.example.connect.chat.DialogListAdapter.OnDialogViewClickListener<DIALOG> clickListener) {
     ...
     */
    public com.example.connect.chat.DialogListAdapter.OnDialogLongClickListener getOnLongItemClickListener() {
     ...
     */
    public void setOnDialogLongClickListener(com.example.connect.chat.DialogListAdapter.OnDialogLongClickListener<DIALOG> onLongItemClickListener) {
     ...
     */
    public com.example.connect.chat.DialogListAdapter.OnDialogViewLongClickListener<DIALOG> getOnDialogViewLongClickListener() {
     ...
     */
    public void setOnDialogViewLongClickListener(com.example.connect.chat.DialogListAdapter.OnDialogViewLongClickListener<DIALOG> clickListener) {
    ...
    public abstract static class BaseDialogsViewHolder<DIALOG extends IDialog>
        ...
        protected com.example.connect.chat.DialogListAdapter.OnDialogClickListener<DIALOG> onDialogClickListener;
        protected com.example.connect.chat.DialogListAdapter.OnDialogLongClickListener<DIALOG> onLongItemClickListener;
        protected com.example.connect.chat.DialogListAdapter.OnDialogViewClickListener<DIALOG> onDialogViewClickListener;
        protected com.example.connect.chat.DialogListAdapter.OnDialogViewLongClickListener<DIALOG> onDialogViewLongClickListener;
        ...
        protected void setOnDialogClickListener(com.example.connect.chat.DialogListAdapter.OnDialogClickListener<DIALOG> onDialogClickListener) {
            this.onDialogClickListener = onDialogClickListener;
        }

        protected void setOnDialogViewClickListener(com.example.connect.chat.DialogListAdapter.OnDialogViewClickListener<DIALOG> onDialogViewClickListener) {
            this.onDialogViewClickListener = onDialogViewClickListener;
        }

        protected void setOnLongItemClickListener(com.example.connect.chat.DialogListAdapter.OnDialogLongClickListener<DIALOG> onLongItemClickListener) {
            this.onLongItemClickListener = onLongItemClickListener;
        }

        protected void setOnDialogViewLongClickListener(com.example.connect.chat.DialogListAdapter.OnDialogViewLongClickListener<DIALOG> onDialogViewLongClickListener) {
