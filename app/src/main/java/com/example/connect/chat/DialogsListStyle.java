...
import com.example.connect.chat.commons.Style;
...
class DialogsListStyle extends Style {
    ...
    static com.example.connect.chat.DialogsListStyle parse(Context context, AttributeSet attrs) {
        com.example.connect.chat.DialogsListStyle style = new com.example.connect.chat.DialogsListStyle(context, attrs);
