...
import com.example.connect.chat.messages.MessageInput;
import com.example.connect.chat.messages.MessagesList;
import com.example.connect.chat.messages.MessagesListAdapter;
...
public class ActivityMainMessage extends AppCompatActivity implements MessagesListAdapter.OnLoadMoreListener, MessageInput.AttachmentsListener,MessageInput.InputListener {
    ...
    public static void start(Context context) {
        Intent starter = new Intent(context, com.example.connect.chat.ActivityMainMessage.class);
       // starter.putExtra();
